...
<body>
    ...
    ?>
        ...
        if (isset($_GET['id'])) {
            ...
            $parkingId = $_GET['id'];
            // get parking info
            $parking = $obj->getParkings($parkingId);
        }
        ...
        if (isset($_POST['update'])) {
            ...
            if ($errors == 0) {
                ...
                echo "<h2>Confirmation of Update</h2>";
                echo "<table border='1'>";
                ...
                echo "<a href='parking_edit.php?id=" . $_POST['id'] . "' class='custom-button'>Go Back</a>";
                echo "</form>";
            ...
            $result = $obj->setParking($location, $description, $space, $cost, $parkingId);

            // display messaage
            echo "<div align='center' class='container'>";
            echo "<p>Information about the location \"<strong>" . $location . "</strong>\" has been successfully updated.</p>";
            echo "<br />";
            ...
            <div class="container" align='left'>
                ...
                <div class="container">
                    <form class="login-form" style="width:90%;" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
                        Parking Location: <br />
                        <input type="text" name="location" value="<?php echo $parking['location']; ?>" /><br />
                        Description: <br />
                        <textarea name="description" cols="50"><?php echo $parking['description']; ?></textarea><br /><br />
                        The number of parking spaces: <em>(Enter digit number(s))</em><br />
                        <input type="number" name="space" value="<?php echo $parking['parking_space']; ?>" /><br /><br />
                        Cost per hour ($):<br />
                        <input type="float" name="cost" value="<?php echo $parking['cost_per_hour']; ?>" /><br /><br />

                        <input type="hidden" name="id" value="<?php echo $parkingId; ?>" />
